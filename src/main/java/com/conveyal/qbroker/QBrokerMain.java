...
public class QBrokerMain {

    private static final Logger LOG = LoggerFactory.getLogger(QBrokerMain.class);
    ...
    public static void main(String[] args) {
        ...
        httpServer.getServerConfiguration().addHttpHandler(new QBrokerHttpHandler(qBroker), "/*");
        try {
            httpServer.start();
            LOG.info("Broker running.");
            qBroker.run(); // run queue broker task pump in this thread
